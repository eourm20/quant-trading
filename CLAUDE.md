...
> - 장중 11:00, 14:00 — `run_intraday_scan()`: 거래량 급증 + HTS 조건검색 → 프리필터 → AI 풀 분석
...
### 신규 종목 편입
- 편입 조건 5가지 중 2가지 이상 충족: 눌림목 / 저평가 / 테마미반영 / 실적개선 / 잠재성장
- 잠재성장: 외인순매수 지속 + 거래량 증가 + 주가 횡보 (축적 단계). 급등 종목(+5% 초과)은 제외
